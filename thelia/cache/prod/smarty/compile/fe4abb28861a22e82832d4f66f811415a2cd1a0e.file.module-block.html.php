<?php /* Smarty version Smarty-3.1.20, created on 2018-12-15 12:12:28
         compiled from "C:\wamp64\www\editorPlugin\thelia\templates\backOffice\default\includes\module-block.html" */ ?>
<?php /*%%SmartyHeaderCode:263175c14efacc2db88-23520646%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fe4abb28861a22e82832d4f66f811415a2cd1a0e' => 
    array (
      0 => 'C:\\wamp64\\www\\editorPlugin\\thelia\\templates\\backOffice\\default\\includes\\module-block.html',
      1 => 1504456426,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '263175c14efacc2db88-23520646',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c14efacc92f42_94266961',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c14efacc92f42_94266961')) {function content_5c14efacc92f42_94266961($_smarty_tpl) {?><div class="general-block-decorator">
...
<?php $_tmp14=ob_get_clean();?><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape((($tmp = @$_smarty_tpl->tpl_vars['caption_title']->value)===null||$tmp==='' ? $_tmp14 : $tmp),$_smarty_tpl);?>
...
<?php $_tmp15=ob_get_clean();?><?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>'ID'),$_smarty_tpl);?>
<?php $_tmp16=ob_get_clean();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['admin_sortable_header'][0][0]->generateSortableColumnHeader(array('current_order'=>$_smarty_tpl->tpl_vars['module_order']->value,'order'=>'id','reverse_order'=>'id_reverse','path'=>$_tmp15,'request_parameter_name'=>'module_order','label'=>$_tmp16),$_smarty_tpl);?>
                ...
                <th>
                <?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->generateUrlFunction(array('path'=>'/admin/modules'),$_smarty_tpl);?>
<?php $_tmp17=ob_get_clean();?><?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>'Name'),$_smarty_tpl);?>
<?php $_tmp18=ob_get_clean();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['admin_sortable_header'][0][0]->generateSortableColumnHeader(array('current_order'=>$_smarty_tpl->tpl_vars['module_order']->value,'order'=>'title','reverse_order'=>'title_reverse','path'=>$_tmp17,'request_parameter_name'=>'module_order','label'=>$_tmp18),$_smarty_tpl);?>

                </th>

                <th>
                <?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->generateUrlFunction(array('path'=>'/admin/modules'),$_smarty_tpl);?>
<?php $_tmp19=ob_get_clean();?><?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>'Code'),$_smarty_tpl);?>
<?php $_tmp20=ob_get_clean();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['admin_sortable_header'][0][0]->generateSortableColumnHeader(array('current_order'=>$_smarty_tpl->tpl_vars['module_order']->value,'order'=>'code','reverse_order'=>'code_reverse','path'=>$_tmp19,'request_parameter_name'=>'module_order','label'=>$_tmp20),$_smarty_tpl);?>
                ...
                <?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->generateUrlFunction(array('path'=>'/admin/modules'),$_smarty_tpl);?>
<?php $_tmp21=ob_get_clean();?><?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>'Enable/Disable'),$_smarty_tpl);?>
<?php $_tmp22=ob_get_clean();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['admin_sortable_header'][0][0]->generateSortableColumnHeader(array('current_order'=>$_smarty_tpl->tpl_vars['module_order']->value,'order'=>'enabled','reverse_order'=>'enabled_reverse','path'=>$_tmp21,'request_parameter_name'=>'module_order','label'=>$_tmp22),$_smarty_tpl);?>

                </th>

                <th class="text-center">
                <?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->generateUrlFunction(array('path'=>'/admin/modules'),$_smarty_tpl);?>
<?php $_tmp23=ob_get_clean();?><?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>'Position'),$_smarty_tpl);?>
<?php $_tmp24=ob_get_clean();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['admin_sortable_header'][0][0]->generateSortableColumnHeader(array('current_order'=>$_smarty_tpl->tpl_vars['module_order']->value,'order'=>'manual','reverse_order'=>'manual_reverse','path'=>$_tmp23,'request_parameter_name'=>'module_order','label'=>$_tmp24),$_smarty_tpl);?>
...
<?php $_tmp25=ob_get_clean();?><?php $_smarty_tpl->smarty->_tag_stack[] = array('loop', array('type'=>"module",'name'=>"module.".((string)$_smarty_tpl->tpl_vars['module_type']->value),'module_type'=>$_tmp25,'order'=>$_smarty_tpl->tpl_vars['module_order']->value,'backend_context'=>1,'hidden'=>$_smarty_tpl->tpl_vars['hidden']->value)); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('type'=>"module",'name'=>"module.".((string)$_smarty_tpl->tpl_vars['module_type']->value),'module_type'=>$_tmp25,'order'=>$_smarty_tpl->tpl_vars['module_order']->value,'backend_context'=>1,'hidden'=>$_smarty_tpl->tpl_vars['hidden']->value), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
<?php $_tmp26=ob_get_clean();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Deactivate %title module",'title'=>$_tmp26),$_smarty_tpl);?>
...
"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"deactivation"),$_smarty_tpl);?>
                                ...
                                <?php } else { ?>
                                    <a title="<?php ob_start();?><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['TITLE']->value,$_smarty_tpl);?>
<?php $_tmp27=ob_get_clean();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"activate %title module",'title'=>$_tmp27),$_smarty_tpl);?>
" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->generateUrlFunction(array('path'=>"/admin/module/toggle-activation/%id",'id'=>$_smarty_tpl->tpl_vars['ID']->value),$_smarty_tpl);?>
...
<?php $_tmp28=ob_get_clean();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['admin_position_block'][0][0]->generatePositionChangeBlock(array('resource'=>"admin.modules",'access'=>"UPDATE",'path'=>$_tmp28,'url_parameter'=>"module_id",'in_place_edit_class'=>"modulePositionChange",'position'=>$_smarty_tpl->tpl_vars['POSITION']->value,'id'=>$_smarty_tpl->tpl_vars['ID']->value),$_smarty_tpl);?>
...
<?php $_tmp29=ob_get_clean();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"modules.table-row",'location'=>"modules_table_row",'module_code'=>$_tmp29),$_smarty_tpl);?>
...
<?php $_tmp30=ob_get_clean();?><?php ob_start();?><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape(ltrim($_smarty_tpl->tpl_vars['zones']->value,', '),$_smarty_tpl);?>
<?php $_tmp31=ob_get_clean();?><?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>'%count shipping zone(s) are attached to this module: %zones. Click here to change','count'=>$_tmp30,'zones'=>$_tmp31),$_smarty_tpl);?>
<?php $_tmp32=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['title'] = new Smarty_variable($_tmp32, null, 0);?>
...
<?php $_tmp33=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['title'] = new Smarty_variable($_tmp33, null, 0);?>
...
" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span></a>
            ...
            <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('type'=>"module",'name'=>"module.".((string)$_smarty_tpl->tpl_vars['module_type']->value),'module_type'=>$_tmp25,'order'=>$_smarty_tpl->tpl_vars['module_order']->value,'backend_context'=>1,'hidden'=>$_smarty_tpl->tpl_vars['hidden']->value), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>

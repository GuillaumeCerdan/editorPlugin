...
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '398c852f34e30c3eb3775b6e809d08da764eab81' => 
    array (
      0 => 'C:\\wamp64\\www\\editorPlugin\\thelia\\templates\\frontOffice\\default\\login.html',
      1 => 1545346140,
      2 => 'file',
    ),
...
" method="post" <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['form_enctype'][0][0]->formEnctype(array(),$_smarty_tpl);?>
 novalidate>
                <?php ob_start();?><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_GET['validation_done'],$_smarty_tpl);?>
<?php $_tmp9=ob_get_clean();?><?php if ($_tmp9) {?>
                    <div class="alert alert-success"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Your customer account was successfully activated, you can now login."),$_smarty_tpl);?>
</div>
                <?php } else { ?>
...
<?php $_tmp11=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['folder_information'] = new Smarty_variable($_tmp11, null, 0);?>

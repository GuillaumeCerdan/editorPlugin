...
<?php /*%%SmartyHeaderCode:201625c4c923b42df25-99661421%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '201625c4c923b42df25-99661421',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c4c923b4621d2_01476962',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c4c923b4621d2_01476962')) {function content_5c4c923b4621d2_01476962($_smarty_tpl) {?><div class="hook-modules table-responsive">
    <table class="table table-striped table-condensed table-left-aligned">
        ...
        <tbody>
            ...
            <?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['MODULE_ACTIVE']->value&&$_smarty_tpl->tpl_vars['HOOK_ACTIVE']->value) {?><?php if ($_smarty_tpl->tpl_vars['ACTIVE']->value) {?><?php echo "1";?><?php } else { ?><?php echo "0";?><?php }?><?php } else { ?><?php echo "0";?><?php }?><?php $_tmp17=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["visible"] = new Smarty_variable($_tmp17, null, 0);?>
...
<?php $_tmp18=ob_get_clean();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Deactivate hook",'title'=>$_tmp18),$_smarty_tpl);?>
...
"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"deactivation"),$_smarty_tpl);?>
                            ...
                            <?php } else { ?>
                            <a title="<?php ob_start();?><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['TITLE']->value,$_smarty_tpl);?>
<?php $_tmp19=ob_get_clean();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"activate hook",'title'=>$_tmp19),$_smarty_tpl);?>
" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->generateUrlFunction(array('path'=>"/admin/module-hooks/toggle-activation/%id",'id'=>$_smarty_tpl->tpl_vars['ID']->value),$_smarty_tpl);?>
...
<?php $_tmp20=ob_get_clean();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['admin_position_block'][0][0]->generatePositionChangeBlock(array('resource'=>"admin.hooks",'access'=>"UPDATE",'path'=>$_tmp20,'url_parameter'=>"module_hook_id",'in_place_edit_class'=>"moduleHookPositionChange",'position'=>$_smarty_tpl->tpl_vars['POSITION']->value,'id'=>$_smarty_tpl->tpl_vars['ID']->value),$_smarty_tpl);?>
